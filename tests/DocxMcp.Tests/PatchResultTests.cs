...
public class PatchResultTests : IDisposable
{
    ...
    {
        var result = DocxMcp.Tools.PatchTool.ApplyPatch(_sessions, _session.Id, "not json");
    ...
    public void DryRun_DoesNotApplyChanges()
    {
        ...
        var json = """[{"op": "add", "path": "/body/children/0", "value": {"type": "paragraph", "text": "New"}}]""";
        var result = DocxMcp.Tools.PatchTool.ApplyPatch(_sessions, _session.Id, json, dry_run: true);
    ...
    public void RemoveColumnOperation_ReturnsColumnIndexAndRowsAffected()
    {
        ...
        DocxMcp.Tools.PatchTool.ApplyPatch(_sessions, _session.Id, addTableJson);
