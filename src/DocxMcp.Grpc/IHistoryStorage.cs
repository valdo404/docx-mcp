...
/// <summary>
/// Interface for history storage operations (sessions, index, WAL, checkpoints).
/// Maps to the StorageService gRPC service.
/// </summary>
public interface IHistoryStorage : IAsyncDisposable
{
    // Session operations
